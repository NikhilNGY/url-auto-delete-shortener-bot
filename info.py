...
GRP_LNK = environ.get('GRP_LNK', '+x6OfRDdUPrUwZTZl')
CHNL_LNK = environ.get('CHNL_LNK', '+fDkIGNmk5BU5ODVl')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+nNUIkuypc4Y2YTFl')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{script.CAPTION}")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<strong><blockquote>Hey {u.mention} 👋🏻\n \n➤Nᴀᴍᴇ: {title} {year}\n➤Yᴏᴜʀ Fɪʟᴇ Rᴇᴀᴅʏ Nᴏᴡ👇</blockquote></strong>")
LONG_IMDB_DESCRIPTION = is_enabled(environ.get("LONG_IMDB_DESCRIPTION", "False"), False)
SPELL_CHECK_REPLY = is_enabled(environ.get("SPELL_CHECK_REPLY", "True"), True)
MAX_LIST_ELM = environ.get("MAX_LIST_ELM", None)
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001693006436')).split()]
...
LOG_STR += f"Your current IMDB template is {script.IMDB_TEMPLATE_TXT}"
